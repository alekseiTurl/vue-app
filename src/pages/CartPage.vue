  ...
  <div>
    ...
    <main class="content container">
      <div class="content__top">
        ...
        <span v-if="products.length === 1" class="content__info">
          {{ products.length }} товар
        </span>
        <span v-else-if="products.length >= 5" class="content__info">
      ...
      <section class="cart position-relative" v-if="$store.state.cartLoading">
        <div class="preloader">
      ...
      <section class="cart" v-else>
        <form class="cart__form form" action="#" method="POST">
          ...
          <div class="cart__block">
            ...
            <router-link tag="button" :to="{ name: 'order' }" v-if="$store.state.cartProducts.length"
